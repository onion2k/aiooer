...
- **The training data is a separate question,** which part 2 of the AI in the organisation module covers, and a permissive licence on the weights says nothing about it.
