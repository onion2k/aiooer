...
The legal position on training data remains contested, with lawsuits, licensing deals and opt-out schemes all in progress. [Part 3 of the AI in the organisation module](file/bbb9efdd-e221) covers what this means for you as a buyer.
...
- **Do not over-build around today's weaknesses.** Elaborate workarounds for a current limitation may be obsolete within a year. Keep them light, and keep a test suite that tells you when a newer model no longer needs them. [Part 9 of the practical AI module](file/7a3f2c68-91de) shows how.
...
The management lesson is to re-test. Something that failed with last year's model may work now, and multi-step agent tasks, covered in [part 5 of the practical AI module](file/1d8f42a6-b93e), are the most threshold-sensitive of all.
...
The rule of thumb: fine-tune for behaviour, retrieve for knowledge. [Part 8 of the practical AI module](file/0b8e5d17-f4c2) covers retrieval. Most engineering teams never need to fine-tune at all.
