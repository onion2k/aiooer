...
- **Changes are reviewable.** A difference between two versions of a JSON prompt shows exactly which field changed. That is the discipline of treating prompts as code, which [part 1 of the practical AI module](file/f3a91c20-6d4e) covers.
